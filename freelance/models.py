...
class Service(models.Model):
    ...
    name = models.CharField(max_length=250)#manga ios razrab kere
    desc = models.CharField(max_length=1000)#ios da proekt bor shuni to'liq
    price = models.IntegerField()#1200$
    service_type = models.CharField(choices=SERVICE_TYPES, default='1',max_length=1)
    def __str__(self):
        #return self.name + self.get_service_type_display() + self.price
